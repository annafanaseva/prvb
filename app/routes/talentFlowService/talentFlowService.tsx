...
const recruitmentFunnelList = [
   ...
   "Фиксированную стоимость кандидата",
...
const channelOverviewList = [
   ...
   "Джоб-борды HeadHunter, Авито, Superjob, Rabota.ru…",
   "Социальные сети и профильные сообщества Telegram MAX VK",
   "offline реклама",
   "Карьерный сайт",
   "Реферальные программы и рассылки",
   "Профессиональные мероприятия: Отраслевые конференции, митапы, хакатоны и бизнес-форумы",
   "Партнерские программы: Коллаборации с вузами, учебными центрами, кадровыми агентствами",
];
const workStages = [
      ...
      <div>
         ...
         <div className="home-page">
            <Hero
               image={heroImage}
               showMetrics={false}
               subTitle="Кадровая лидогенерация. Приводим целевых кандидатов на ваши вакансии. Без шума, без воды - только валидные отклики."
            >
            ...
            <ServiceDescription
               title={<>Обеспечим ваш HR-отдел потоком кандидатов</>}
               subTitle={
                  <>
            ...
            <RecruitmentFunnelOffer
               ...
               heading={
                  <>
                     Кандидата на любом этапе HR воронки - от
            ...
            <ServiceOverview
               ...
               boxTwoTitle="Что такое кадровая лидогенерация?"
            ...
            />
            <ChannelOverview
               title="Каналы генарации HR трафика:"
            ...
            <ContactUs
               ...
               subtitle="Оставьте заявку и мы разработаем стратегии привлечения, которые обеспечат ваш HR-отдел стабильным потоком кандидатов"
            />
         </div>
      </div>
   );
