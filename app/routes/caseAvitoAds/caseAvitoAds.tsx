...
function CaseAvitoAds() {
   return (
      <div>
         {/* Meta */}
         <title>
            Avito Pro и Avito Ads для рекрутмента | Сравнение инструментов
         </title>
         <meta
            property="og:title"
            content="Avito Pro и Avito Ads для рекрутмента | Сравнение инструментов"
         />
         <meta
            name="description"
            content="Сравнение Avito Pro и Avito Ads для подбора персонала. Узнайте, какой инструмент подходит для массового найма, рекламы вакансий и привлечения кандидатов."
         />
         <meta
            name="keywords"
            content="Avito Pro, Avito Ads, реклама вакансий на Авито, массовый подбор персонала, привлечение кандидатов, рекрутинг, Авито вакансии"
         />
         ...
         <div className="case">
            ...
            <HowWeWork
               ...
               sectionParagraph={
                  <>
                     <span>
                        Но внутри Avito есть два принципиально разных
                        инструмента:
                        <br />
                        <br />
                     </span>
               ...
               <div className="feat__wrap">
                  ...
                  <div className="feat__content">
                     <h2 className="feat__title">
                        <span className="highlight">Avito Pro</span> -
                        управление размещениями
                     </h2>

                     <p className="feat__lead">
                        Avito Pro - это профессиональный кабинет работодателя.
                        Он позволяет:
                     </p>
            ...
            <div className="intro">
               <h5 className="intro__text">
                  <span className="intro__space" />
                  <span className="highlight">
                     Для массового рекрутмента это база - без него сложно
                     управлять десятками и сотнями вакансий.
                  </span>
               </h5>
            </div>
                     ...
                     <div className="note__text">
                        ...
                        <ul className="note__list">
                           <li className="note__li">
                              <CheckIcon />
                              Если в конкретном регионе спрос низкий, охват
                              будет ограничен.
                           </li>
                           <li className="note__li">
                              <CheckIcon />
               ...
               <div className="note__wrap">
                  <div className="note__body">
                     <div className="note__text">
                        <h4 className="note__title">
                           Здесь{" "}
                           <span className="highlight">логика другая</span>
                        </h4>
               ...
               <div className="note__wrap">
                  <div className="note__body">
                     <div className="note__text">
                        ...
                        <p className="note__subtitle">
                           В реальной практике эффективнее всего работает
                           гибридная модель:
                        </p>
                        ...
                        <ul className="note__list">
                           <li className="note__li">
                              ...
                              <span>
                                 <strong>Avito Pro</strong> - для управления
                                 всеми вакансиями и обработки откликов
                              </span>
                           </li>
                           <li className="note__li">
                              <span className="note__emoji">🎯</span>
                              <span>
                                 <strong>Avito Ads</strong> - для
                                 масштабирования и привлечения дополнительного
                                 потока
                              </span>
                           </li>
                        </ul>
            ...
            <ServiceDescription
               ...
               subTitle={
                  <>
                     ...
                     <span className="highlight">Avito Pro</span> - вы зависите
                     от текущего спроса. Если подключать{" "}
