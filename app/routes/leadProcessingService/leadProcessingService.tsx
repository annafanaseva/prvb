...
function leadProcessingService() {
   return (
      <div>
         {/* Meta */}
         <title>
            Обработка откликов кандидатов и прозвон анкет за 15 минут
         </title>
         <meta
            property="og:title"
            content="Обработка откликов кандидатов и прозвон анкет за 15 минут"
         />
         <meta
            name="description"
            content="Не даём лидам остыть: звоним кандидатам в первые 15 минут, проверяем релевантность, мотивацию и готовность к собеседованию. Передаём валидные лиды в HR."
         />
         <meta
            name="keywords"
            content="обработка лидов, обработка откликов кандидатов, ресечинг кандидатов, call-центр для HR, прозвон анкет, валидация кандидатов, подбор персонала"
         />
            ...
            <ServiceDescription
               ...
               subTitle={
                  <>
                     ...
                     <span className="highlight"> первые 15 минут</span>,
                     превращая
