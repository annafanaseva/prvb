...
function landingService() {
   return (
      <div>
         {/* Meta */}
         <title>
            Лендинги для вакансий и HR-сайты, которые приводят кандидатов
         </title>
         <meta
            property="og:title"
            content="Лендинги для вакансий и HR-сайты, которые приводят кандидатов"
         />
         <meta
            name="description"
            content="Создаём посадочные страницы для вакансий и HR-сайты под ключ. Больше откликов, ниже стоимость кандидата, интеграция с CRM и быстрый запуск от 1 дня."
         />
         <meta
            name="keywords"
            content="лендинг для вакансии, HR-лендинг, сайт для подбора персонала, посадочная страница для вакансий, HR-сайт, привлечение кандидатов, рекрутинг"
         />
            ...
            <ServiceDescription
               ...
               subTitle={
                  <>
                     ...
                     вакансии, которые повышают конверсию и превращают
                     посетителей в{" "}
                     <span className="highlight">реальных кандидатов</span>
                  </>
               }
            />
