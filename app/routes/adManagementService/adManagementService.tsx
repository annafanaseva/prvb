...
export const meta: Route.MetaFunction = () => {
   return [
      ...
      },
      {
         name: "keywords",
         content:
            "реклама вакансий, ведение рекламных кампаний, HR-реклама, продвижение вакансий, привлечение кандидатов, таргетированная реклама, контекстная реклама, подбор персонала",
      },
   ];
};
