...
function creativeAdsService() {
   return (
      <div>
         {/* Meta */}
         <title>
            Креативы для рекламы вакансий | HR-рекламные материалы под ключ
         </title>
         <meta
            property="og:title"
            content="Креативы для рекламы вакансий | HR-рекламные материалы под ключ"
         />
         <meta
            name="description"
            content="Разрабатываем креативные концепции и рекламные материалы для подбора персонала. Баннеры, сторис, тексты, видео и офлайн-носители для привлечения кандидатов."
         />
         <meta
            name="keywords"
            content="креативы для вакансий, рекламные материалы для подбора персонала, HR-креативы, реклама вакансий, баннеры для вакансий, привлечение кандидатов, HR-маркетинг"
         />
         {/* Content */}
         <div className="creative-ads-service">
            ...
            <ServiceDescription
               ...
               subTitle={
                  <>
                     Мы{" "}
                     <span className="highlight">разрабатываем креатив,</span>{" "}
